...
kult_of_pop()->print_styles( 'kult-of-pop-c-header' );
/* kult_of_pop()->print_script( 'kult-of-pop-c-header' ); */
...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'kult-of-pop' ); ?></a>
