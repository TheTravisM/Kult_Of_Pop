...
add_action( 'wp_enqueue_scripts', 'kult_of_pop_custom_gutenberg_css' );
/**
 * Outputs front-end inline styles based on colors declared in config/block-editor-settings.php.
 *
 * @since 2.9.0
 */
function kult_of_pop_custom_gutenberg_css() {
...
CSS;
	...
	$css .= kult_of_pop_inline_font_sizes();
	$css .= kult_of_pop_inline_color_palette();

	wp_add_inline_style( CHILD_THEME_HANDLE . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'kult_of_pop_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function kult_of_pop_custom_gutenberg_admin_css() {
...
CSS;
	...
	wp_add_inline_style( 'kult_of_pop-gutenberg-fonts', $css );
 ...
 */
function kult_of_pop_inline_font_sizes() {
 ...
 */
function kult_of_pop_inline_color_palette() {
