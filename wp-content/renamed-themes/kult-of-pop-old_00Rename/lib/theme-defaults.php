...
add_filter( 'genesis_theme_settings_defaults', 'kult_of_pop_theme_defaults' );
/**
 ...
 */
function kult_of_pop_theme_defaults( $defaults ) {
...
add_filter( 'simple_social_default_styles', 'kult_of_pop_social_default_styles' );
/**
 ...
 */
function kult_of_pop_social_default_styles( $defaults ) {
