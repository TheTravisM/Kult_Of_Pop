...
add_action( 'wp_enqueue_scripts', 'kult_of_pop_css' );
/**
...
function kult_of_pop_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'kult_of_pop_logo_width', 350 );
	...
	$css .= ( kult_of_pop_customizer_get_default_link_color() !== $color_link ) ? sprintf(
		'
	...
	$css .= ( kult_of_pop_customizer_get_default_accent_color() !== $color_accent ) ? sprintf(
		'
