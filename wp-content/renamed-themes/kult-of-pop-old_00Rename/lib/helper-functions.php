 ...
 */
function kult_of_pop_customizer_get_default_link_color() {
 ...
 */
function kult_of_pop_customizer_get_default_accent_color() {
 ...
 */
function kult_of_pop_color_contrast( $color ) {
 ...
 */
function kult_of_pop_color_brightness( $color, $change ) {
